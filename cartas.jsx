...
function CartasScene() {
  ...
  return (
    <div style={{
      ...
      alignItems: 'center',
      padding: 'calc(env(safe-area-inset-top, 0px) + 92px) 16px calc(env(safe-area-inset-bottom, 0px) + 100px)',
      ...
      {/* Month chip grid removed — using arrow nav at the bottom for more letter room */}
